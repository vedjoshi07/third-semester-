document.addEventListener('DOMContentLoaded', () => {
    const movieLists = {
        'trending-movies': [
            {
                ...
                fallback: 'https://via.placeholder.com/150x200/E50914/FFFFFF?text=Squid+Game',
            ...
            },
            {
                ...
                fallback: 'https://via.placeholder.com/150x200/E50914/FFFFFF?text=Money+Heist',
                description: 'A criminal mastermind manipulates the police, hostages and the public using the Royal Mint of Spain.',
            },
            {
                title: 'Wednesday',
                thumbnail: 'https://picsum.photos/150/200?random=3',
                fallback: 'https://via.placeholder.com/150x200/E50914/FFFFFF?text=Wednesday',
                description: 'A coming-of-age supernatural mystery series starring Jenna Ortega as Wednesday Addams.',
            },
            {
                title: 'The Crown',
                thumbnail: 'https://picsum.photos/150/200?random=4',
                fallback: 'https://via.placeholder.com/150x200/E50914/FFFFFF?text=The+Crown',
            ...
            {
                title: 'Ozark',
                thumbnail: 'https://picsum.photos/150/200?random=5',
                fallback: 'https://via.placeholder.com/150x200/E50914/FFFFFF?text=Ozark',
        ...
        'netflix-originals': [
            {
                ...
                thumbnail: 'https://picsum.photos/150/200?random=6',
                fallback: 'https://via.placeholder.com/150x200/E50914/FFFFFF?text=Queens+Gambit',
            ...
            },
            {
                ...
                thumbnail: 'https://picsum.photos/150/200?random=7',
                fallback: 'https://via.placeholder.com/150x200/E50914/FFFFFF?text=Stranger+Things',
                description: 'When a young boy vanishes, a small town uncovers a mystery involving secret experiments.',
            },
            {
                title: 'Orange Is the New Black',
                thumbnail: 'https://picsum.photos/150/200?random=8',
                fallback: 'https://via.placeholder.com/150x200/E50914/FFFFFF?text=OITNB',
                description: 'A privileged New Yorker ends up in a women\'s prison when a past crime catches up with her.',
            },
            {
                title: 'House of Cards',
                thumbnail: 'https://picsum.photos/150/200?random=9',
                fallback: 'https://via.placeholder.com/150x200/E50914/FFFFFF?text=House+of+Cards',
        ...
        'action-movies': [
            {
                title: 'Extraction',
                thumbnail: 'https://picsum.photos/150/200?random=10',
                fallback: 'https://via.placeholder.com/150x200/E50914/FFFFFF?text=Extraction',
            ...
            {
                title: 'The Old Guard',
                thumbnail: 'https://picsum.photos/150/200?random=11',
                fallback: 'https://via.placeholder.com/150x200/E50914/FFFFFF?text=The+Old+Guard',
            ...
            {
                title: '6 Underground',
                thumbnail: 'https://picsum.photos/150/200?random=12',
                fallback: 'https://via.placeholder.com/150x200/E50914/FFFFFF?text=6+Underground',
            ...
            },
            {
                ...
                thumbnail: 'https://picsum.photos/150/200?random=13',
                fallback: 'https://via.placeholder.com/150x200/E50914/FFFFFF?text=Triple+Frontier',
        ...
        'comedy-movies': [
            {
                ...
                thumbnail: 'https://picsum.photos/150/200?random=14',
                fallback: 'https://via.placeholder.com/150x200/E50914/FFFFFF?text=The+Good+Place',
                description: 'A woman finds herself in the afterlife\'s The Good Place, where she quickly realizes she doesn\'t belong.',
            },
            {
                title: 'Space Force',
                thumbnail: 'https://picsum.photos/150/200?random=15',
                fallback: 'https://via.placeholder.com/150x200/E50914/FFFFFF?text=Space+Force',
            ...
            {
                title: 'Dead to Me',
                thumbnail: 'https://picsum.photos/150/200?random=16',
                fallback: 'https://via.placeholder.com/150x200/E50914/FFFFFF?text=Dead+to+Me',
                description: 'A series about a powerful friendship that blossoms between a tightly wound widow and a free spirit.',
            },
            {
                title: 'Russian Doll',
                thumbnail: 'https://picsum.photos/150/200?random=17',
                fallback: 'https://via.placeholder.com/150x200/E50914/FFFFFF?text=Russian+Doll',
        ...
        'horror-movies': [
            {
                title: 'Bird Box',
                thumbnail: 'https://picsum.photos/150/200?random=18',
                fallback: 'https://via.placeholder.com/150x200/E50914/FFFFFF?text=Bird+Box',
                description: 'A woman and a pair of children are blindfolded and make their way through a dystopian setting.',
            },
            {
                title: 'The Haunting of Hill House',
                thumbnail: 'https://picsum.photos/150/200?random=19',
                fallback: 'https://via.placeholder.com/150x200/E50914/FFFFFF?text=Hill+House',
            ...
            },
            {
                ...
                fallback: 'https://via.placeholder.com/150x200/E50914/FFFFFF?text=Midnight+Mass',
            ...
            },
            {
                ...
                fallback: 'https://via.placeholder.com/150x200/E50914/FFFFFF?text=Midnight+Club',
    ...
    function createImageWithFallback(movie) {
        ...
        // If main image fails, use fallback
    ...
    for (const [listId, movies] of Object.entries(movieLists)) {
        ...
        if (container) {
            movies.forEach(movie => {
                const imgElement = createImageWithFallback(movie);
